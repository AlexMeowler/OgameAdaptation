...
import org.retal.offgame.old.core.EntityCategory;
import org.retal.offgame.old.core.Planet;
import org.retal.offgame.old.core.Player;
...
public class BuildingPanel extends InfoPanel 
{
	...
	private class BuildingImg extends JLabel
	{
		...
		{
			setIcon(new ImageIcon(getClass().getResource("/static/img/buildings/" + img_num + ".gif")));
